...
const hide = [paths.LOGIN_PAGE, paths.REGISTER_PAGE, paths.EMAIL_RESET_PASSWORD_PAGE, paths.NEW_PASSWORD_PAGE, paths.RESET_PASSWORD_PAGE, paths.DETAIL_VILLAGE_PAGE, paths.NOTIFICATION_PAGE, paths.MAKE_ADS]
