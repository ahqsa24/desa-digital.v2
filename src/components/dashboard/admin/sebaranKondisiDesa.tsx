import { Box, Flex, Text, Button, Table, Thead, Tbody, Tr, Th, Td, TableContainer, useDisclosure, ModalOverlay, Modal, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Select, ModalFooter } from "@chakra-ui/react";
    ...
    const fetchDesaData = async () => {
        try {
            ...
            snapshot.docs.forEach((doc) => {
                ...
                // 🚨 **FILTER KALAU ADA "Lorem Ipsum" ATAU KOSONG** 🚨
                if (
                    ...
                    console.warn(`⚠️ Data "${namaDesa || "Tanpa Nama"}" tidak valid, dilewati.`);
                    return; // **Skip data ini, gak bakal masuk tabel!**
                }
    
                // 🚨 **Batas maksimal 3 kata** 🚨
