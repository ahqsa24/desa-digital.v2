...
const DashboardAdminInovasi: React.FC = () => {
    ...
    const stats = [
        { label: "Inovasi", value: 107 },
    ];
    // Data Pie Chart - 5 Provinsi
    const data = [
        { name: "E-Government", value: 14, color: "#A7C7A5" },
        { name: "System Information", value: 10, color: "#1E5631" },
        { name: "Smart Farming", value: 20, color: "#174E3B" },
    ];
    ...
    const renderCustomizedLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, name }: LabelProps) => {
        ...
        return (
            <text x={x} y={y} fill="white" textAnchor="middle" dominantBaseline="central" fontSize={12} fontWeight="bold" fontFamily="poppins">
    ...
    return (
        <Box>
                        ...
                        {stats.map((stat, index) => (
                            ...
                            >
                                <Flex direction="column">
                                    ...
                                    <Text fontSize="13px" color="gray.600">{stat.label}</Text>
                                </Flex>
                            </Box>
                        ))}
                    </Grid>
            ...
            {/* PIE CHART SEBARAN KATEGORI INOVASI */}
            <Flex justify="space-between" align="center" mt="2px" mx="15px">
                {/* Judul */}
            ...
            {/* PIE CHART SEBARAN KATEGORI INOVASI SELESAI */}
